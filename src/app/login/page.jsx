...
export default async function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      <div className="hidden bg-red-900 md:flex w-1/2 p-12 items-center justify-center relative">
        <div className="max-w-lg space-y-6 text-white z-10">
          ...
          <p className="text-right text-lg text-black font-bold">- Manikanta</p>
        </div>
